(function ($) {
    ...
    $('.carosuel-slider--v2').slick({
        ...
        responsive: [{
            breakpoint: 768,
            settings: {
                prevArrow: '<button type="button" class="carosuel-triangle carosuel-triangle--prev"><i class="icon icon-triangle-right"></i></button>',
                nextArrow: '<button type="button" class="carosuel-triangle carosuel-triangle--next"><i class="icon icon-triangle-left"></i></button>',
            }
        }, ]
    });
    /* ---------------------------------------------
    ...
    $('.carosuel-slider--v3').slick({
        ...
        rtl: true,
        slidesToShow: 3,
        prevArrow: '<button type="button" class="carosuel-cursor carosuel-arrow--prev"><i class="icon icon-arrow-right"></i></button>',
        nextArrow: '<button type="button" class="carosuel-cursor carosuel-arrow--next"><i class="icon icon-arrow-left"></i></button>',
    ...
    $('.carosuel-slider--v4').slick({
        infinite: false,
        slidesToShow: 3,
        prevArrow: '<button type="button" class="carosuel-cursor carosuel-cursor--dark carosuel-arrow--prev"><i class="icon icon-arrow-right"></i></button>',
        nextArrow: '<button type="button" class="carosuel-cursor carosuel-cursor--dark carosuel-arrow--next"><i class="icon icon-arrow-left"></i></button>',
        rtl: true,
